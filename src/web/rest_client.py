...
# }
# GET {{aiMapper}}
def call_health_agent_api_Status(api_url: str = "http://localhost:8000") -> dict:
    """
...
def call_health_agent_api(input_data: str, api_url: str = "http://localhost:8000/map") -> dict:
    """
